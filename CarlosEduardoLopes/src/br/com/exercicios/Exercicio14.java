...
public class Exercicio14 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i <= medias.length; i++) {
			nomes[i] = Teclado.lerTexto("Digite o " +(i+1)+ "º nome: "); 
			notas1[i] = Teclado.lerDouble("Digite a " +(i+1)+ "ª primeira nota: "); 
			notas2[i] = Teclado.lerDouble("Digite a " +(i+1)+ "ª segunda nota: ");
